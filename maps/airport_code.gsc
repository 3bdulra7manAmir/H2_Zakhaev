...
_id_C8E1()
{
    ...
    level.player setViewmodel( "globalViewhands_mw2_airborne" );
    level.player takeweapon( "spas12_reflex" );
    level.player takeweapon( "h2_weapon_kriss_acog_silencer" );
...
if ( !isdefined( level._id_A87F.tactical_greenberet ) || !level._id_A87F.tactical_greenberet )
    {
        level.player setViewmodel( "globalViewhands_mw2_airborne" );
        level.player giveweapon( "h2_weapon_kriss_acog_silencer" );
        level.player switchtoweapon( "h2_weapon_kriss_acog_silencer" );
    }
    ...
    {
        level.player setViewmodel( "globalViewhands_mw2_airborne" );
        level.player giveweapon( "spas12_reflex" );
        level.player giveweapon( "h2_weapon_kriss_acog_silencer" );
        level.player setoffhandprimaryclass( "fraggrenade" );
        level.player giveweapon( "fraggrenade" );
        level.player setoffhandsecondaryclass( "flash_grenade" );
        level.player giveweapon( "flash_grenade" );
        level.player givemaxammo( "h2_weapon_kriss_acog_silencer" );
        level.player setweaponammoclip( "h2_weapon_kriss_acog_silencer", 30 );
        level.player switchtoweapon( "h2_weapon_kriss_acog_silencer" );
    }
